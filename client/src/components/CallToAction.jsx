  ...
  return (
    <section className="py-12 sm:py-16 relative z-10 bg-[#fffff2] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-[#1a361d] via-[#152a17] to-[#0d1c10] text-[#fffff2] border border-[#2d5c36] shadow-2xl p-6 sm:p-6 lg:p-8 relative overflow-hidden text-left">
