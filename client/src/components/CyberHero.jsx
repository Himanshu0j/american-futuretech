      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-7 text-left">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-slate-900/90 border border-sky-500/50 shadow-[0_0_25px_rgba(14,165,233,0.3)] backdrop-blur-xl transition-all duration-300 hover:scale-105 group cursor-default">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-cyan-500" />
              </span>
              <span className="text-amber-400 text-xs">⚡</span>
              <span className="text-xs md:text-sm font-bold tracking-wide bg-gradient-to-r from-sky-400 via-cyan-200 to-sky-300 bg-clip-text text-transparent">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black font-heading tracking-tight text-white leading-[1.12]">
              ...
              <span className="relative inline-block bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_0_35px_rgba(14,165,233,0.45)]">
                American FutureTech
                <span className="absolute -bottom-1 left-0 right-0 h-[3px] bg-gradient-to-r from-sky-400 via-cyan-300 to-blue-600 rounded-full shadow-[0_0_12px_#38bdf8]" />
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-1 w-full sm:w-auto">
              ...
              <button
                ...
                className="w-full sm:w-auto px-7 py-3.5 rounded-full font-semibold text-sm text-slate-200 bg-[#0f172a]/80 hover:bg-[#1e293b] border border-slate-700/80 hover:border-sky-400/50 hover:text-white backdrop-blur-xl transition-all duration-300 flex items-center justify-center gap-2.5 shadow-lg hover:shadow-[0_0_25px_rgba(14,165,233,0.25)] group cursor-pointer"
              >
                <div className="w-6 h-6 rounded-full bg-sky-500/20 border border-sky-400/40 flex items-center justify-center text-sky-400 group-hover:scale-110 group-hover:bg-sky-500/30 transition-all">
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-sky-500/25 via-blue-600/20 to-transparent rounded-3xl blur-2xl -z-10 animate-pulse-slow" />
            ...
            <div className="relative w-full max-w-lg mx-auto transform hover:scale-[1.02] transition-transform duration-500">
                ...
                <div className="rounded-xl bg-[#040711] border border-white/10 p-5 sm:p-6 relative overflow-hidden min-h-[310px] flex flex-col justify-between">
                  ...
                  <div className="flex items-center justify-between z-10">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded bg-gradient-to-tr from-rose-500 to-sky-400 p-0.5 shadow-[0_0_10px_#38bdf8]">
                    ...
                    <span className="text-[10px] font-mono text-cyan-400 bg-cyan-950/70 border border-cyan-700/60 px-2.5 py-0.5 rounded-full flex items-center gap-1.5 shadow-[0_0_12px_rgba(14,165,233,0.3)]">
                  ...
                  <div className="my-auto py-3 z-10 flex flex-col items-center text-center">
                    ...
                    <div className="space-y-1 mb-3">
                      <div className="text-lg sm:text-xl font-extrabold tracking-tight text-white font-heading drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">
                        Data Science <span className="text-sky-400">+ AI</span>
                      </div>
                    ...
                    <div className="flex items-end justify-center gap-1.5 h-10 mt-3 w-full max-w-[260px]">
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-1 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-2 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-3 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-4 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-5 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-6 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-7 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-8 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-2 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-5 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-3 shadow-[0_0_8px_#38bdf8]" />
                      <div className="w-1.5 rounded-full bg-gradient-to-t from-sky-500 to-cyan-300 eq-bar-1 shadow-[0_0_8px_#38bdf8]" />
              ...
              <div className="hidden sm:flex absolute top-1/2 -right-12 items-center gap-2 px-3.5 py-2 rounded-xl bg-[#0f172a]/95 border border-rose-500/50 backdrop-blur-xl shadow-[0_0_25px_rgba(244,63,94,0.35)] animate-float-fast z-20">
