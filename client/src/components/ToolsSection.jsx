    ...
    <section id="tools" className="py-12 bg-slate-50 dark:bg-[#0B132B] border-t border-slate-200/60 dark:border-slate-800 relative">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-4xl rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl p-6 sm:p-6 max-h-[90vh] overflow-hidden flex flex-col text-left">
