...
export const HeroEducationIllustration = ({ className = "w-full h-auto" }) => (
  <svg viewBox="0 0 520 400" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <rect x="170" y="190" width="180" height="115" rx="10" fill="#0B1220" filter="url(#aft-soft-shadow)" />
    ...
    <rect x="190" y="220" width="70" height="4" rx="2" fill="#E5C275" />
    ...
    <rect x="190" y="260" width="80" height="4" rx="2" fill="#E5C275" />
    ...
    <g className="animate-float-slow">
      ...
      <rect x="52" y="132" width="40" height="6" rx="3" fill="#0B1220" />
      <circle cx="65" cy="165" r="8" fill="#EFE6D6" stroke="#10b981" strokeWidth="1.5" />
      <circle cx="100" cy="150" r="8" fill="#ffe6fa" stroke="#4338CA" strokeWidth="1.5" />
      <circle cx="135" cy="170" r="8" fill="#e0f2fe" stroke="#4338CA" strokeWidth="1.5" />
    ...
    <g className="animate-float-delayed">
      ...
      <rect x="380" y="172" width="90" height="5" rx="2.5" fill="#0B1220" />
    ...
    <g className="animate-float-drift">
      ...
      <path d="M260 76 L278 84 L260 92 L242 84 Z" fill="#0B1220" />
      <path d="M248 88 L248 97 C248 102 272 102 272 97 L272 88" fill="#4338CA" />
...
export const LearnIllustration = ({ className = "w-24 h-24" }) => (
  <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <rect x="20" y="24" width="80" height="20" rx="10" fill="#0B1220" />
    <circle cx="30" cy="34" r="2.5" fill="#E5C275" />
    <circle cx="38" cy="34" r="2.5" fill="#ffffff" fillOpacity="0.6" />
    <rect x="28" y="52" width="40" height="4" rx="2" fill="#4338CA" />
...
export const PracticeIllustration = ({ className = "w-24 h-24" }) => (
  <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Git Branch Flow */}
    <circle cx="40" cy="60" r="8" fill="#0B1220" stroke="#E5C275" strokeWidth="2" />
    <circle cx="60" cy="40" r="7" fill="#4338CA" />
    <circle cx="60" cy="80" r="7" fill="#4338CA" />
    <circle cx="82" cy="60" r="9" fill="#10b981" stroke="#ffffff" strokeWidth="2" />
    <path d="M48 60 L73 60" stroke="#64748b" strokeWidth="2" />
    <path d="M45 54 C48 42 54 40 60 40 C66 40 74 46 76 54" stroke="#4338CA" strokeWidth="2" fill="none" strokeDasharray="3 3" />
    <path d="M45 66 C48 78 54 80 60 80 C66 80 74 74 76 66" stroke="#4338CA" strokeWidth="2" fill="none" strokeDasharray="3 3" />
  </svg>
);
...
export const CertifyIllustration = ({ className = "w-24 h-24" }) => (
  <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <rect x="35" y="32" width="50" height="5" rx="2.5" fill="#0B1220" />
...
export const CareerReadyIllustration = ({ className = "w-24 h-24" }) => (
  <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Briefcase Base */}
    <rect x="32" y="44" width="56" height="42" rx="7" fill="#0B1220" />
    <path d="M46 44 L46 36 C46 32 74 32 74 36 L74 44" stroke="#0B1220" strokeWidth="3" fill="none" />
    <line x1="32" y1="58" x2="88" y2="58" stroke="#4338CA" strokeWidth="2" />
    {/* Success Badge */}
    <circle cx="60" cy="64" r="8" fill="#E5C275" />
    <path d="M57 64 L59 66 L63 62" stroke="#0B1220" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const MissionIllustration = ({ className = "w-full h-auto" }) => (
  <svg viewBox="0 0 380 280" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Central Pillar */}
    <rect x="155" y="80" width="70" height="120" rx="12" fill="#0B1220" />
    <rect x="165" y="92" width="50" height="6" rx="3" fill="#E5C275" />
    {/* Upward Growth Arrow */}
    <path d="M190 190 L190 115" stroke="#E5C275" strokeWidth="4" strokeLinecap="round" />
    <polygon points="182,122 190,105 198,122" fill="#E5C275" />
    {/* Orbiting Milestone Nodes */}
    <circle cx="100" cy="110" r="16" fill="#ffffff" stroke="#10b981" strokeWidth="2" filter="url(#aft-soft-shadow)" />
    <circle cx="280" cy="110" r="16" fill="#ffffff" stroke="#4338CA" strokeWidth="2" filter="url(#aft-soft-shadow)" />
    <circle cx="190" cy="230" r="16" fill="#ffffff" stroke="#4338CA" strokeWidth="2" filter="url(#aft-soft-shadow)" />
  </svg>
);
...
export const VisionIllustration = ({ className = "w-full h-auto" }) => (
  <svg viewBox="0 0 420 280" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <circle cx="210" cy="140" r="14" fill="#0B1220" stroke="#E5C275" strokeWidth="2" />
    <circle cx="140" cy="110" r="10" fill="#10b981" />
    <circle cx="280" cy="120" r="10" fill="#4338CA" />
    <circle cx="170" cy="180" r="9" fill="#4338CA" />
    <circle cx="260" cy="185" r="9" fill="#f59e0b" />
    {/* Connection Beams */}
    <line x1="210" y1="140" x2="140" y2="110" stroke="#10b981" strokeWidth="1.5" />
    <line x1="210" y1="140" x2="280" y2="120" stroke="#4338CA" strokeWidth="1.5" />
    <line x1="210" y1="140" x2="170" y2="180" stroke="#4338CA" strokeWidth="1.5" />
...
export const CTAIllustration = ({ className = "w-full h-auto" }) => (
  <svg viewBox="0 0 360 260" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <IllustrationDefs />
    <circle cx="180" cy="130" r="100" fill="#E5C275" fillOpacity="0.12" />
    {/* Rocket Propulsion Body */}
    <path d="M180 50 C195 90 205 130 198 160 L162 160 C155 130 165 90 180 50 Z" fill="#ffffff" stroke="#0B1220" strokeWidth="2.5" />
    <circle cx="180" cy="95" r="10" fill="#10b981" />
    {/* Wings */}
    <path d="M162 140 L140 165 L164 165 Z" fill="#4338CA" />
    <path d="M198 140 L220 165 L196 165 Z" fill="#4338CA" />
    {/* Exhaust Flames */}
