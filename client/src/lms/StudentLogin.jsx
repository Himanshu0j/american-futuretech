    ...
    <div className="min-h-screen bg-[#fffff2] text-slate-900 flex flex-col justify-center items-center px-4 py-12 relative selection:bg-[#76ff8a] selection:text-[#1a361d]">
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
          <h2 className="text-2xl font-heading font-black text-[#1a361d] mb-1">Learner Authentication</h2>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            <button
              ...
              className="w-full py-2.5 px-4 rounded-full bg-[#fffff2] hover:bg-slate-50 text-[#1a361d] text-xs font-bold border-2 border-[#1a361d] transition-colors flex items-center justify-center gap-2 shadow-xs cursor-pointer"
            >
          ...
          <div className="mt-5 text-center text-xs text-slate-600">
            ...
            <Link to="/student/register" className="text-[#2d5c36] hover:text-[#1a361d] font-bold hover:underline">
