      ...
      <main className="pt-28 pb-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-left">
        ...
        <div className="prose prose-slate max-w-none text-xs sm:text-sm leading-relaxed space-y-8 text-slate-700">
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-display font-bold text-[#0B1220]">1. Introduction & Scope</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-display font-bold text-[#0B1220]">2. Information We Collect</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-display font-bold text-[#0B1220]">3. How We Use Your Data</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-display font-bold text-[#0B1220]">4. Data Retention & Security</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-display font-bold text-[#0B1220]">5. Contact Institutional Privacy Officer</h2>
            <div className="p-4 rounded-2xl bg-white border border-slate-200 space-y-1 font-mono text-xs">
              ...
              <p>Email: <a href="mailto:info@americantechgloballlc.com" className="text-[#4338CA] hover:underline">info@americantechgloballlc.com</a></p>
